...
public class FractionNumberOperationImpl implements FractionNumberOperation {
    ...
    public FractionNumber sub(FractionNumber a, FractionNumber b) throws NullPointerException {
        int dividendResult = a.getDividend() * b.getDividend();
        int divisorResult = a.getDivisor() * b.getDivisor();
        FractionNumberImpl subResult = new FractionNumberImpl();
        subResult.setDividend(dividendResult);
        subResult.setDivisor(divisorResult);
